...
define Device/h6xk-common
  ...
  KERNEL := kernel-bin
  DEVICE_PACKAGES := kmod-r8125 kmod-ata-ahci-dwc kmod-thermal kmod-iio-rockchip-saradc
...
define Device/hinlink_opc-h69k
  ...
  DEVICE_PACKAGES += kmod-hwmon-pwmfan kmod-usb-net-qmi-wwan kmod-usb-net-cdc-mbim kmod-usb-serial-option
